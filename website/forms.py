...
letter_validator = RegexValidator(r'^[a-zA-Z ]+$', 'Only letters and spaces are allowed.')
...
postcode_validator = RegexValidator(r'^[a-zA-Z0-9][a-zA-Z0-9\- ]{0,10}[a-zA-Z0-9]$', 'Enter a valid postcode/zipcode e.g. N1 1AD.')
vat_validator = RegexValidator(r'^GB|gb[0-9]{9}([0-9]{3})?$', 'Enter a valid UK VAT number, GB followed by nine numbers e.g. GB123456789')
...
class AddSupplierForm(forms.ModelForm):
    supplier_name = forms.CharField(required=True, validators=[alphanumeric_validator], widget=forms.widgets.TextInput(attrs={"placeholder":"Supplier Name", "class":"form-control"}), label="")
    ...
    supplier_phone = forms.CharField(required=True, validators=[phone_validator], widget=forms.widgets.TextInput(attrs={"placeholder":"Supplier Phone", "class":"form-control"}), label="")
...
class AddDetailForm(forms.ModelForm):
    ...
    vat_no = forms.CharField(required=True, validators=[vat_validator], widget=forms.widgets.TextInput(attrs={"placeholder":"VAT Number", "class":"form-control"}), label="")
...
class AddExclusionForm(forms.ModelForm):
    ...
    exclusion_date = forms.DateField(required=False, widget=forms.widgets.TextInput(attrs={"placeholder":"Date of Exclusion ", "class":"form-control"}), label="", validators=[MaxValueValidator(timezone.now().date()),MinValueValidator(timezone.now().date() - timezone.timedelta(days=365*10+3))])
